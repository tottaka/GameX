...
namespace GameX
{
    ...
    {
        internal static List<GameObject> PhysicsObjects = new List<GameObject>();

        internal static Simulation simulator;
        ...
        public static void Run()
        {
            ...
            simulator = Simulation.Create(bufferPool, new NarrowPhaseCallbacks(), new PoseIntegratorCallbacks(new Vector3(0, -10, 0)), new PositionLastTimestepper());

            //Add a big state box...
            simulator.Statics.Add(new StaticDescription(new Vector3(0, 0, 0), new CollidableDescription(simulator.Shapes.Add(new Box(500, 1, 500)), 0.1f)));
        }
        ...
        public static void Step(float deltaTime)
        {
            ...
            simulator.Timestep(deltaTime);//, threadDispatcher);
        }
